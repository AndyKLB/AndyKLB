...
**Systems & Software Developer · 42 Paris · Looking for Alternance 2026**
...
| Area | Skills |
|------|--------|
| **Languages** | C · C++ (98/17) · TypeScript · Shell/Bash · Python |
| **Systems** | Linux · POSIX · Processes · Memory · Sockets · Threads · IPC |
| **Network** | TCP/IP · UDP · DNS · HTTP · SSL/TLS · Routing |
| **DevOps** | Docker · Docker Compose · Git · Make · NGINX · CI (basics) |
| **QA / Debug** | GDB · Valgrind · Integration testing · Regression analysis |
...
- **Level:** 11.75 / 21
- **Common Core:** ✅ 100%
- **Current status:** 42 Advanced Part
- **Total project hours:** ~1800H+

---

## 🎯 Looking For

- **Alternance / Apprentissage** starting September/October 2026
- **Roles:** QA Automation · Cybersecurity Analyst · Backend Developer · Systems Developer
- **Location:** Paris IDF + Remote/Hybrid · Open to international
- **Company size:** Large enterprise or structured mid-size

---

## 📬 Contact

📧 andy.ka@hotmail.fr · [[LinkedIn](https://www.linkedin.com/in/andykammerer/)](link) · Paris, France
